            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Imate pitanja o našim proizvodima ili trebate savet za izbor patika? 
                  Kontaktirajte nas - tu smo da vam pomognemo!
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Pozovite nas za brzu konsultaciju</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Pošaljite nam detaljno pitanje</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">{SITE_CONFIG.company.location}</p>
                    <p className="text-gray-500 text-sm mt-1">Dostava širom Srbije</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Pratite nas za najnovije vesti</p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Preporučujemo da izaberete patike za pola broja veće od vaše uobičajene veličine. 
                Ovo je posebno važno za trail patike. Noge se šire tokom dana i dugog trčanja.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Patike za početnike imaju veću amortizaciju, stabilnost i zaštitu. Napredne patike su 
                lakše, sa manje amortizacije, dizajnirane za brzinu i efikasnost.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Da, nudimo dostavu širom Srbije. Kontaktirajte nas za informacije o cenama dostave 
                i vremenu isporuke.
              </p>
            </div>
          </div>
