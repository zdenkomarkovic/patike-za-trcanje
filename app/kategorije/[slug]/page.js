          ...
          <section className="py-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src={getImageUrl(category.image, 1200)}
            ...
            {products.length > 0 ? (
                      ...
                      <div className="p-6">
                        ...
                        {product.price && (
                          <div className="flex items-center justify-between mb-4">
                            ...
                            {product.inStock ? (
                              <span className="text-green-600 text-sm font-medium">Na stanju</span>
                            ) : (
                              <span className="text-red-600 text-sm font-medium">Nema na stanju</span>
                            )}
                          </div>
                        )}
                        ...
                        <Button 
                          variant="primary" 
                          className="w-full"
                          onClick={() => window.location.href = `/proizvodi/${product.slug.current}`}
                        >
                          Pogledaj detalje
                        </Button>
                      </div>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-600 mb-8">
                  Trenutno nema dostupnih proizvoda u kategoriji "{category.name}".
                </p>
                <Button 
                  variant="primary"
                  onClick={() => window.location.href = '/kategorije'}
                >
