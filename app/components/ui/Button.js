...
const buttonVariants = {
  primary:
    "bg-gradient-to-r from-blue-600 to-red-600 text-white hover:opacity-90",
  secondary:
    "border-2 border-white text-white hover:bg-white hover:text-[#494179]",
  outline:
    "border-2 border-gray-300 text-gray-700 hover:border-blue-600 hover:text-blue-600",
  ghost: "text-gray-700 hover:text-[#494179] hover:bg-gray-100",
};
